...
- Shopify's [theme-tools](https://github.com/Shopify/theme-tools), used in their online [code editor](https://shopify.dev/docs/storefronts/themes/tools/code-editor) and the [official VS code extension](https://marketplace.visualstudio.com/items?itemName=shopify.theme-check-vscode).
